...
document.getElementById('overlay').addEventListener('mousemove', (event) => {
  ...
  cursorContainer.style.top = (event.clientY - 65) + "px";
  cursorContainer.style.left = (event.clientX - 65) + "px";
...
document.getElementById('overlay').addEventListener('click', (event) => {
  ...
  if (moved) {
    hidden.style.top = (event.clientY - 65) + "px";
    hidden.style.left = (event.clientX - 65) + "px";
  }
